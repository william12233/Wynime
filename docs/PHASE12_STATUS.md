...
The v1.0.6 release boundary is ready for exact-SHA CI and protected
...
## 1.0.6 candidate status

- Version authority is `1.0.6+7`; the expected arm64 split APK versionCode is
  `2007`.
...
- Flutter analyzer, the full deterministic test suite (224 tests), broker
  typecheck, broker tests (28 tests) and the verifier runtime probe pass on
