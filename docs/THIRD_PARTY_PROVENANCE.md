...
linked into libmpv. The complete `COPYING.LGPLv2.1` text and the
corresponding-source/relink offer are copied into both Windows distributions
and verified by the release workflow.
