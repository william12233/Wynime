...
This release carries the source-to-playback integration boundary and the
generated detailed-plan snapshot on the immutable `main` commit.

## Platforms and distribution

- Android arm64-v8a APK: `wynime-1.0.14-arm64-v8a.apk`.
- Windows x64 ZIP (portable): `wynime-1.0.14.zip`.
...
- Full deterministic Flutter suite: 772 tests passed before the release-only
  version increment; protected Phase 0 CI must re-run at the immutable tag SHA.
