...
void main() {
  ...
  test('manifest and artifact inventory persist as one authoritative unit', () async {
  ...
  test('artifact conflict rolls back the whole new manifest transaction', () async {
    final database = openTestDatabase();
    addTearDown(database.close);
    final repository = DriftArtifactManifestRepository(database);
